...
from sweaur2.constructor_tests import constructor_for_bearer_checks, constructor_for_mac_checks, constructor_for_token_endpoint
...
globals().update(constructor_for_mac_checks(DjangoTokenStore(), DjangoClientStore()))
